...
class DioConsumer implements ApiConsumer {
  ...
  DioConsumer({required this.client}) {
    //by7sl bad certificate error while performing dio w code dh by7lh
    ...
    if (kDebugMode) {
      //use to print request bst5dmh bdl ma fe datasource a3ml print ll response dh ele hy3ml keda
  ...
  Future post(String path,
      {Map<String, dynamic>? body, bool formDataIsEnabled = false,
